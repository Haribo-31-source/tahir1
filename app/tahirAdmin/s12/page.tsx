...
export default function Page() {
    ...
    useEffect(() => {
        const fetchTopNotes = async () => {
          try {
            const response = await fetch("/tahirAdmin/s12/api/admin");
    ...
    const fetchNote = async () => {
      ...
      setError("");
      try {
        const res = await fetch("/tahirAdmin/s12/api/getNote", {
          method: "POST",
    ...
    const updateNote = async () => {
      ...
      setError("");
      try {
        const res = await fetch("/tahirAdmin/s12/api/updateNote", {
          method: "PUT",
    ...
    const handleDelete = async (id: number) => {
        const response = await fetch("/tahirAdmin/s12/api/delete", {
          method: "DELETE",
          headers: { "Content-Type": "application/json" },
